                            ...
                            <div class="float-end">
                                <div class="status_area">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('tasks.index') }}" class="btn btn-primary float-end">
                                                <i class="fa-solid fa-list me-1"></i>All Task
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="whitebox mb-4">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" aria-label="work_task_status" id="work_task_id" name="work_task_status">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" aria-label="task_type" id="task_id" name="task_type" data-bs-toggle="modal" data-bs-target="#CreateAssetModal"  style="cursor:pointer">
                                                <option value="">--Select--</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="description"
                                            class="col-form-label text-md-end text-start">Task Type</label>
                                        <select class="form-control" aria-label="task_type" id="task_id" name="task_type"> -->
                                                <option value="">--Select--</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <label for="old_chkbox" class="col-form-label text-md-end text-start">Create a new work order even if there are work orders not closed from this Scheduled Task</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul class="nav nav-tabs" id="notificationsTabs">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#notifyOnAssignment" id="notifyOnAssignment">
                                        <i class="fa fa-exclamation" alt="Notify when Work Task is Created and Assigned to Technicians" title="Notify when Work Task is Created and Assigned to Technicians"></i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#notifyOnStatusChange" id="notifyOnStatusChange">
                                        <i class="fa fa-exchange" alt="Notify if Work Task Status Changes" title="Notify if Work Task Status Changes"></i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#notifyOnCompletion" id="notifyOnCompletion">
                                        <i class="fa fa-check" alt="Notify when Work Task is Completed" title="Notify when Work Task is Completed"></i>
                                    </a>
                                </li>
                                <li class="nav-item">
